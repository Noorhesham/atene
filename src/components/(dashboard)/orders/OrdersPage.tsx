...
import { Loader2, CheckSquare, ChevronLeft, Search } from "lucide-react";
...
const OrdersPage = () => {
  ...
  return (
    <>
      <PageHeader
        addButton={{ label: "إضافة طلب", href: "/dashboard/orders/add" }}
        navLinks={[{ label: "الطلبـــــات", href: "/dashboard", isActive: true }]}
      />
