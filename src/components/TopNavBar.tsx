        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-100 py-2">
            <div className="space-y-2 pb-3">
              ...
              <button className="w-full text-left px-4 py-2 text-[13px] text-[#414141] hover:text-black hover:bg-gray-50">
                خدمات
              </button>
              <button className="w-full text-left px-4 py-2 text-[13px] text-[#414141] hover:text-black hover:bg-gray-50">
                كل الفئات
            ...
            <div className="border-t border-gray-100 pt-3">
              <button className="w-full text-left px-4 py-2 text-[13px] text-[#414141] hover:text-black hover:bg-gray-50 flex items-center gap-1">
                <span>دولار</span>
                <ChevronDown size={14} className="text-[#414141]" />
              </button>
              <button className="w-full text-left px-4 py-2 text-[13px] text-[#414141] hover:text-black hover:bg-gray-50 flex items-center gap-1.5">
                <img src="/black.svg" alt="UAE Flag" className="w-4 h-4" />
                <span>السوق الإ</span>
                <ChevronDown size={14} className="text-[#414141]" />
              </button>
